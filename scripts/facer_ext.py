...
def single_tab():
    ...
    with gr.Row():
        included_parts = gr.Checkbox(['Hair', 'Ear', 'Face', 'Neck', 'Clothes'], label='Included parts', value='best')
        excluded_parts = gr.Checkbox(['Hair', 'Ear', 'Face', 'Neck', 'Clothes'], label='Excluded parts', value='best')
    with gr.Row():
